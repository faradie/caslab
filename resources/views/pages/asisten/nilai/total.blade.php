...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">List Total Nilai Ujian!</h1>
  ...
  <table class="table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
            <form action="{{ route('list_nilai_ujian',$ujian->id) }}" method="post">
                {{ csrf_field() }}
                {{ method_field('PATCH') }}
                <input class="btn btn-info" name="submitbutton" type="submit" value="Daftar Nilai" />
              </form>
        </td>
      </tr>
      @endforeach
